  ...
  <head>
    ...
    <style>
         body {
                  ...
                  background-image: url("https://plus.unsplash.com/premium_photo-1664391861823-0108d5b5fe87?q=80&w=1498&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D");
...
%> 
    <div class="navbar">
      ...
      <a href="provideDiscountToProducts.jsp">Provide Discount</a>
    </div>
    <div class="container">
    ...
    <% } else { %> 
    <div  class="container">
<a href="HotelLogin.jsp">Please Login First</a>
</div>
    <% } %>	
    <footer>
