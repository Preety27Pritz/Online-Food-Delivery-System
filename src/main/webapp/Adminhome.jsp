  ...
  <head>
    ...
    <style>
      body {
        ...
        background-image: url("https://img.freepik.com/free-photo/burger-french-fries-plate-with-copy-space_23-2148235009.jpg?size=626&ext=jpg&ga=GA1.1.1141335507.1718409600&semt=ais_user");
  ...
  <body>
    ...
    <div class="parent">
      <div class="main">
        ...
        <a href="addadmin"><i class="fas fa-user-plus"></i> Register</a>
        <a href="Adminlogin.jsp"><i class="fas fa-sign-in-alt"></i> Login</a>
      </div>
    </div>
  </body>
</html>
