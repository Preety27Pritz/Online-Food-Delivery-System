...
<html lang="en">
  <head>
    ...
    <style>
         body {
                  ...
                  background-image: url("https://images.unsplash.com/photo-1558959357-685f9c7ace7b?q=80&w=1470&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D");
  ...
  <body>
    <% Admin admin = (Admin) session.getAttribute("admininfo"); if (admin !=
    null) { %> 
    <div class="navbar">
      <img
      ...
      <a href="viewBlock">Block Hotels</a>
      <a href="viewUnblock">Unblock Hotels</a>
    </div>
    <div class="container">
